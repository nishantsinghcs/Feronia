...
<div class="storewidth">	
  ...
  <!-- menu bar end -->
	...
	<div id="region" class="floatleft" align="left" style="padding: 8px 13px;font-size: 14px;line-height: 1.42857143;color: #555555;background-color: #ffffff;"><!-- InstanceBeginEditable name="cinemascope" -->

 <div style="font-family:'proxima-nova-condensed', 'Calibri', 'Cantarell', sans-serif;color:#69b010;font-size:55px;padding:10px;">
          <br> <strong>Terms and Conditions.<br></strong>
  </div>
          <?php
          include_once('./admin/config.php');
           $result2 = mysql_query("SELECT * FROM termsconditions");
...
<br><br><br><br><br><br>
	  ...
	  <!-- InstanceEndEditable -->
		...
		<div id="footer" class="floatleft" style="margin-top:100px">
